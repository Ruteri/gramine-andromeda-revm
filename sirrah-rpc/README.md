...
[![Goreport status](https://goreportcard.com/badge/github.com/flashbots/gramine-andromeda-revm/sirrah-rpc)](https://goreportcard.com/report/github.com/flashbots/go-template)
[![Test status](https://github.com/flashbots/gramine-andromeda-revm/sirrah-rpc/workflows/Checks/badge.svg?branch=main)](https://github.com/flashbots/go-template/actions?query=workflow%3A%22Checks%22)

Toolbox and building blocks for new Go projects, to get started quickly and right-footed!

* [`Makefile`](https://github.com/flashbots/gramine-andromeda-revm/sirrah-rpc/blob/main/Makefile) with `lint`, `test`, `build`, `fmt` and more
